...
st.write("Penyakit diabetes tipe 2 adalah penyakit yang paling umum di dunia dan ditimbulkan oleh berbagai macam sebab, seperti faktor genetik, gaya hidup, dan lingkungan. Faktor terjadinya Diabetes Tipe 2 dapat dibagi menjadi dua yaitu:")
...
st.write(
  ...
  - Riwayat Penyakit : Riwayat melahirkan bayi dengan Berat Badan Lahir (BBL) > 4 kg atau Diabetes Mellitus Gestasional dan Riwayat Terkena Sindrom Ovarium Polikistik.
...
st.write(
  ...
  - Gula Darah: Mengukur gula darah untuk menentukan seseorang terkena Diabetes Mellitus Tipe 2 atau tidak.
...
st.subheader("Komplikasi Penyakit Diabetes")
st.write(
  """
